...
"""
import subprocess
p = subprocess.run("sudo apt-get install libxrender1")
...
st.markdown("""
Filter FDA Approved Drugs by [Lipinski's Rule-of-Five](https://en.wikipedia.org/wiki/Lipinski%27s_rule_of_five)
""")
...
raw_html = mols2grid.display(df_result4,
                            smiles_col="smiles",
                            subset=["img", "generic_name", "MW", "LogP", "NumHDonors", "NumHAcceptors"], 
